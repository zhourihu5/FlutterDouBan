...
class _MoviePageState extends State<MoviePage>  with AutomaticKeepAliveClientMixin {
  ...
  Widget _getComingSoonItem(Subject comingSoonBean, var itemW) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        RouterDb.push(context, RouterDb.detailPage, comingSoonBean.id);
      },
    );
  }
  ...
  Widget _getHotMovieItem(Subject hotMovieBean, var itemW) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        RouterDb.push(context, RouterDb.detailPage, hotMovieBean.id);
      },
    );
  }
      ...
      child: CustomScrollView(
        ...
        slivers: <Widget>[
          ...
          getCommonImg(Constant.IMG_TMP1, (){
            RouterDb.pushNoParams(context, "http://www.flutterall.com");
          }),
          SliverToBoxAdapter(
            child: Padding(
