    ...
    return Row(
      ...
      children: <Widget>[
        _TextImgWidget(
          ...
          tabCallBack: () {
            print('点击找电影');
            RouterDb.push(context, RouterDb.searchPage, '找电影');
          },
        ),
        _TextImgWidget(
          '豆瓣榜单',
          ...
          tabCallBack: () {
            print('点击豆瓣榜单');
            RouterDb.push(context, RouterDb.searchPage, '豆瓣榜单');
          },
        ),
        _TextImgWidget(
          '豆瓣猜',
          ...
          tabCallBack: () {
            RouterDb.push(context, RouterDb.searchPage, '豆瓣猜');
          },
        ),
        _TextImgWidget(
          '豆瓣片单',
          ...
          tabCallBack: () {
            RouterDb.push(context, RouterDb.searchPage, '豆瓣片单');
          },
        )
      ],
    );
